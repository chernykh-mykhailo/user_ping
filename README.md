...
**Примітка:** Docker образ включає шрифти DejaVu/Liberation для кирилиці та бібліотеку `pilmoji` для рендерингу емодзі як зображень (Twemoji). Емодзі відображаються коректно на всіх платформах.
